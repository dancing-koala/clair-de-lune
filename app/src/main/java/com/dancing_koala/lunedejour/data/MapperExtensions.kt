...
import com.dancing_koala.lunedejour.network.*
import com.dancing_koala.lunedejour.persistence.*
...
fun UnlockedPicture.toEntity() = UnlockedPictureEntity(
    id = id,
    pictureId = pictureId,
    unlockedAt = unlockedAt
)

fun UnlockedPictureEntity.toDataModel() = UnlockedPicture(
    id = id,
    pictureId = pictureId,
    unlockedAt = unlockedAt
)
